...
export default class RegistrScreenLogin extends Component {
  constructor() {
    super();
    this.state = {
      username: '',
            ...
            <ScrollView>
              ...
              <View style={[styles.button]}>
                ...
                <TouchableOpacity
                  ...
                  style={[
                    styles.signIn,
                    {borderColor: '#ed785a', borderWidth: 1, marginTop: 15},
                  ]}>
                  <Text style={[styles.textSign, {color: '#ed785a'}]}>
                    注册
                  </Text>
                </TouchableOpacity>
              </View>
